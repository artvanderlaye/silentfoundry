...
(function(){
 ...
 function paraEl(){
  ...
  [].forEach.call(g.querySelectorAll('*'),function(e){
   ...
   if(/^These principles define/.test((e.textContent||'').trim()))para=e;});
  return para;
 }
 ...
 function topAlign(){
  ...
  var first=t.querySelector('.dl-tk');
  var para=paraEl();
 ...
 var n=0;
 (function poll(){ var ok=apply(); mobile(); twoCol(); paraType(); eyebrows(); topAlign(); if(++n<80)setTimeout(poll,ok?500:120); })();
 addEventListener('resize',function(){ apply(); twoCol(); paraType(); eyebrows(); topAlign(); });
})();
